...
(function () {
  ...
  if (tb) {
    if (localStorage.getItem("meridian-theme") === "dark") {
      ...
      tb.setAttribute(
        "aria-label",
        tb.dataset.labelLight || "Switch to light theme"
      );
    }
    tb.addEventListener("click", function () {
      ...
      if (dark) {
        ...
        tb.setAttribute(
          "aria-label",
          tb.dataset.labelDark || "Switch to dark theme"
        );
  ...
  /* ── MARQUAGE SECTIONS SYNTHÈSE ──────────────────────── */
  /* Pose .has-synth-content sur les sections qui ont du contenu
     visible en mode synthèse (callout, blockquote, table).
     Doit tourner avant l'activation éventuelle du mode synthèse. */
  function markSynthSections() {
    document.querySelectorAll("main section").forEach(function (s) {
      var hasContent = s.querySelector("details.callout, blockquote, table");
      s.classList.toggle("has-synth-content", !!hasContent);
    });
  }
  markSynthSections();
  ...
  document.querySelectorAll(".copy-btn").forEach(function (btn) {
    btn.addEventListener("click", function () {
      ...
      var text = code.querySelector("code")
        ? code.querySelector("code").innerText
        : "";
